...
1. Введение
В рамках работы была изучена библиотека Scapy, выполнена настройка перехвата HTTP‑трафика, анализ взаимодействия с веб‑приложением Google Gruyere, а также эксплуатация XSS‑уязвимостей.
Цель — понять, как выглядит HTTP‑трафик при обычной работе и при атаке, а также выявить и продемонстрировать XSS‑уязвимости.
